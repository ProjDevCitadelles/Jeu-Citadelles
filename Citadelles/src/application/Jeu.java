...
public class Jeu {
    ...
    void afficherLesRegles() {
        ...
        textArea.setText("Règles du jeu Citadelles :\n\n" +
                "Objectif du Jeu:\n" +
                "Construire la cité la plus prestigieuse en accumulant des quartiers.\n" +
                "La partie se termine lorsqu'un joueur construit son huitième quartier.\n" +
                "Le gagnant est celui avec le plus de points de victoire.\n\n" +
                "Composition du Jeu:\n" +
                "- Cartes Quartier: Divers types avec des coûts et des points.\n" +
                "- Cartes Personnage: Huit personnages, chacun avec des pouvoirs spéciaux.\n" +
                "- Pièces d'or.\n" +
                "- Couronne: Indique le premier joueur.\n\n" +
                "Déroulement d'une Partie:\n" +
                "1. Distribution des Personnages:\n" +
                "   - Choix de personnage en fonction de la couronne.\n" +
                "   - Certaines cartes de personnages sont mises de côté.\n\n" +
                "2. Tour de Jeu:\n" +
                "   - Les joueurs, dans l'ordre des personnages, effectuent leurs actions.\n" +
                "   - Actions: Prendre des pièces OU piocher des cartes Quartier,\n" +
                "     utiliser le pouvoir du personnage, construire un quartier.\n\n" +
                "3. Pouvoirs des Personnages:\n" +
                "   - Chaque personnage a un pouvoir unique.\n\n" +
                "4. Construction des Quartiers:\n" +
                "   - Dépenser de pièces d'or pour construire des quartiers.\n" +
                "   - Chaque quartier construit apporte des points de victoire.\n\n" +
                "5. Fin de la Partie et Calcul des Points:\n" +
                "   - Fin de partie : quand un joueur construit son huitième quartier.\n" +
                "   - Calcul des points : valeur des quartiers, ensembles complets,\n" +
                "     quartiers bonus, conditions spécifiques des cartes.\n\n" +
                "Stratégie:\n" +
                "- Choix judicieux des personnages et gestion des ressources.\n" +
                "- Anticiper les choix des autres joueurs.\n" +
                "- Utiliser les pouvoirs pour avancer et entraver les adversaires.\n\n" +
                "Citadelles offre une profondeur stratégique dans chaque partie.\n");
